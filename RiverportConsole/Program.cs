...
namespace Handelabra.MyModConsole // this has to be this way to work around an EngineCommon issue, will be fixed soon.
{
    ...
    class MainClass
    {
        ...
        private static Game ConfigureGameForTesting()
        {
            ...
            game = new Game(new string[] { "Omnitron", "Riverport.Dragontamer", "Riverport.Weaver", "Riverport.Fenrir", "Riverport.ScarletX", "PikeIndustrialComplex" }, advanced, promos, isChallenge: challenge);
