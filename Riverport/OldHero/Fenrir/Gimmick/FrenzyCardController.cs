...
namespace Riverport.Fenrir
{
    public class FrenzyCardController : FenrirBaseCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DestroyCardAction>((DestroyCardAction dca) => (dca.CardToDestroy.Card.IsTarget) && IsFenrir(dca.ResponsibleCard), DoFrenzy, TriggerType.Other, TriggerTiming.After);
        ...
        {
            var destroy = this.GameController.SelectAndDestroyCard(HeroTurnTakerController, new LinqCardCriteria(c => !c.IsCharacter && (c.HitPoints <= 3 || c.IsDevice) && !c.IsHero) , false, null, CharacterCard, GetCardSource());
